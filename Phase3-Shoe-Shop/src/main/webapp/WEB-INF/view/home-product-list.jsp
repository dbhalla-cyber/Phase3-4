...
<div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><strong class="text-black">Mens' Section </strong></div>
        </div>
      </div>
    </div>
          ...
          <div class="col-md-9 order-2">
            ...
            <div class="row">
              <div class="col-md-12 mb-5">
                <div class="float-md-left mb-4"><h2 class="text-black h5">Happy Shoe Shopping </h2>
              ...
              <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                <div class="block-4 text-center border">
                  ...
                  <div class="block-4-text p-4">
                    <h3><a href="/Fashion-Store/login?pid=${pd.id}">${pd.name}</a></h3>
