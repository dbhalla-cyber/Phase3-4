        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
              <div class="site-logo">
                <a href="#" class="js-logo-clone">Shoe-Shop</a>
              </div>
            </div>
        ...
        <div class="container">
          ...
          <%if(userbean!=null){ %>
           ...
           <%if(userbean.getRoleId()==1){ %>
             ...
             <li><a href="/Fashion-Store/category">Add Shoe Category</a></li>
             <li><a href="/Fashion-Store/category/search">Shoe Category </a></li>
              <li><a href="/Fashion-Store/prod">Add Shoe</a></li>
              <li><a href="/Fashion-Store/prod/search">Shoe List</a></li>
             <li><a href="/Fashion-Store/bookProd/search">User Shopping List</a></li>
             
              
            <%}else{ %>
            <li><a href="/Fashion-Store/bookProd/search">BUY Product</a></li>
            <%} %>
            <%}%>
